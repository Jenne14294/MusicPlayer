...
class TrayIcon(QSystemTrayIcon):
    def __init__(self, icon_path, parent=None):
        ...
        # 播放控制項目
        self.play_action = QAction("▶ 播放")
        self.pause_action = QAction("⏸ 暫停/繼續")
        self.prev_action = QAction("⏮ 上一首")
        self.next_action = QAction("⏭ 下一首")
...
class YouTubePlayer(QWidget):
    ...
    def init_ui(self):
        ...
        self.pause_button = QPushButton("⏸ 暫停/繼續")
        ...
        layout.addWidget(self.current_label, 6, 0, 1, 2)
